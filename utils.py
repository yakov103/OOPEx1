...
#     return counter
#
# def UpdatePostion (elev:Elevator, calls:[CallForElevator], c:CallForElevator):
#     pos = elev.getPos()
#     timeOfCall = c.time
#
#
# def floMove (elev:Elevator, c:CallForElevator): ## returns how mamy floor moved
#     return (c.time - elev._timePostion )/ elev.getSpeed()
#
#
#
#
